...
\begin{frame}
  ...
  \centering
    ...
    \includegraphics[width=.42\textwidth]{TalkPics/hig14038preapproval/output_qcdJiJj/DataMC_PARKED_dijet_deta.pdf}
    \includegraphics[width=.42\textwidth]{TalkPics/hig14038preapproval/output_qcdJiJj/DataMC_PARKED_dijet_dphi.pdf}

    \includegraphics[width=.42\textwidth]{TalkPics/hig14038preapproval/output_qcdJiJj/DataMC_PARKED_metnomuons.pdf}
    \includegraphics[width=.42\textwidth]{TalkPics/hig14038preapproval/output_qcdJiJj/DataMC_PARKED_metnomu_significance.pdf}
