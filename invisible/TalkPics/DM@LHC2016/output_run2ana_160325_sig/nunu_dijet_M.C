...
// ------------>Primitives in pad: upper
   ...
   upper->Draw();
   upper->cd();
   upper->Range(719.375,-9.76363,4525.625,55.32724);
   ...
   TH1F *QCD14 = new TH1F("QCD14","dijet_M {( (jet1_eta*jet2_eta<0 && abs(jet1_eta)<4.7 && abs(jet2_eta)<4.7 && dijet_M>1100&&jet1_pt>80&&dijet_deta>3.6&& jet2_pt>70&&metnomuons>200) && (nvetomuons==0&&nvetoelectrons==0&&metnomuons>200&&dijet_M>1100&&alljetsmetnomu_mindphi>=2.3) ) * (total_weight_lepveto*1.024*1)}",21,1100,4145);
   QCD14->SetBinContent(1,3.084839);
   QCD14->SetBinError(1,3.084839);
   QCD14->SetEntries(21);
   ...
   totalerrordijet_M18->SetBinContent(1,28.36647);
   totalerrordijet_M18->SetBinContent(2,20.87837);
   totalerrordijet_M18->SetBinContent(3,18.43234);
   totalerrordijet_M18->SetBinContent(4,12.0757);
   ...
   totalerrordijet_M18->SetBinContent(21,1.480484);
   totalerrordijet_M18->SetBinError(1,6.419522);
   totalerrordijet_M18->SetBinError(2,4.724915);
   totalerrordijet_M18->SetBinError(3,4.171362);
   totalerrordijet_M18->SetBinError(4,2.732811);
   ...
   totalerrordijet_M18->SetBinError(21,0.3350435);
   ...
   totlinedijet_M19->SetBinContent(1,28.36647);
   totlinedijet_M19->SetBinContent(2,20.87837);
   totlinedijet_M19->SetBinContent(3,18.43234);
   totlinedijet_M19->SetBinContent(4,12.0757);
   ...
   totlinedijet_M19->SetBinContent(21,1.480484);
   totlinedijet_M19->SetBinError(1,6.419522);
   totlinedijet_M19->SetBinError(2,4.724915);
   totlinedijet_M19->SetBinError(3,4.171362);
   totlinedijet_M19->SetBinError(4,2.732811);
   ...
   totlinedijet_M19->SetBinError(21,0.3350435);
   ...
   Double_t Graph_from_Data_fx3002[21] = {
   1172.5,
   1317.5,
   1462.5,
   1607.5,
   ...
   3927.5,
   4072.5};
   Double_t Graph_from_Data_fy3002[21] = {
   33,
   23,
   17,
   15,
   ...
   0,
   0};
   Double_t Graph_from_Data_felx3002[21] = {
   72.5,
   72.5,
   72.5,
   72.5,
   ...
   72.5,
   72.5};
   Double_t Graph_from_Data_fely3002[21] = {
   5.715412,
   4.760806,
   4.082258,
   3.829449,
   ...
   0,
   0};
   Double_t Graph_from_Data_fehx3002[21] = {
   72.5,
   72.5,
   72.5,
   72.5,
   ...
   72.5,
   72.5};
   Double_t Graph_from_Data_fehy3002[21] = {
   6.802707,
   5.865355,
   5.203825,
   4.958839,
   ...
   1.841055,
   1.841055};
   TGraphAsymmErrors *grae = new TGraphAsymmErrors(21,Graph_from_Data_fx3002,Graph_from_Data_fy3002,Graph_from_Data_felx3002,Graph_from_Data_fehx3002,Graph_from_Data_fely3002,Graph_from_Data_fehy3002);
   ...
   Graph_Graph_from_Data3002->SetMaximum(43.78298);
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("Signal","Signal","ff");
   entry->SetFillStyle(1001);
