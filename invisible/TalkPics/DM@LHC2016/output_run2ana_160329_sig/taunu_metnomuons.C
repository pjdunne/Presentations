...
//=========  (Tue Mar 29 09:04:59 2016) by ROOT version6.02/13
...
// ------------>Primitives in pad: upper
   ...
   upper->Draw();
   upper->cd();
   upper->Range(172.5,-3.97166,447.5,19.39104);
