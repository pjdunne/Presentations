...
// ------------>Primitives in pad: upper
   ...
   upper->Draw();
   upper->cd();
   upper->Range(148,-6.848662,668,33.43758);
   ...
   TH1F *QCD4 = new TH1F("QCD4","metnomuons {( (jet1_eta*jet2_eta<0 && abs(jet1_eta)<4.7 && abs(jet2_eta)<4.7 && dijet_M>1100&&jet1_pt>80&&dijet_deta>3.6&& jet2_pt>70&&metnomuons>200) && (nvetomuons==0&&nvetoelectrons==0&&alljetsmetnomu_mindphi>1) ) * (total_weight_lepveto*1.024*1)}",26,200,616);
   QCD4->SetBinContent(2,0.005573228);
   QCD4->SetBinContent(4,0.6251771);
   QCD4->SetBinContent(5,2.221649);
   QCD4->SetBinContent(6,0.6053159);
   QCD4->SetBinContent(8,0.3225119);
   QCD4->SetBinError(2,0.005573227);
   QCD4->SetBinError(4,0.6251771);
   QCD4->SetBinError(5,2.221649);
   QCD4->SetBinError(6,0.605316);
   QCD4->SetBinError(8,0.3225119);
   QCD4->SetEntries(26);
   QCD4->SetDirectory(0);
   QCD4->SetStats(0);
   ...
   totalerrormetnomuons8->SetBinContent(2,14.82237);
   totalerrormetnomuons8->SetBinContent(3,13.95533);
   totalerrormetnomuons8->SetBinContent(4,11.45157);
   totalerrormetnomuons8->SetBinContent(5,10.77969);
   totalerrormetnomuons8->SetBinContent(6,10.54202);
   totalerrormetnomuons8->SetBinContent(7,7.770311);
   totalerrormetnomuons8->SetBinContent(8,5.153372);
   ...
   totalerrormetnomuons8->SetBinError(2,3.354402);
   totalerrormetnomuons8->SetBinError(3,3.158184);
   totalerrormetnomuons8->SetBinError(4,2.591568);
   totalerrormetnomuons8->SetBinError(5,2.439516);
   totalerrormetnomuons8->SetBinError(6,2.38573);
   totalerrormetnomuons8->SetBinError(7,1.758473);
   totalerrormetnomuons8->SetBinError(8,1.166243);
   ...
   totlinemetnomuons9->SetBinContent(2,14.82237);
   totlinemetnomuons9->SetBinContent(3,13.95533);
   totlinemetnomuons9->SetBinContent(4,11.45157);
   totlinemetnomuons9->SetBinContent(5,10.77969);
   totlinemetnomuons9->SetBinContent(6,10.54202);
   totlinemetnomuons9->SetBinContent(7,7.770311);
   totlinemetnomuons9->SetBinContent(8,5.153372);
   ...
   totlinemetnomuons9->SetBinError(2,3.354402);
   totlinemetnomuons9->SetBinError(3,3.158184);
   totlinemetnomuons9->SetBinError(4,2.591568);
   totlinemetnomuons9->SetBinError(5,2.439516);
   totlinemetnomuons9->SetBinError(6,2.38573);
   totlinemetnomuons9->SetBinError(7,1.758473);
   totlinemetnomuons9->SetBinError(8,1.166243);
   ...
   Double_t Graph_from_Data_fx3002[26] = {
   208,
   224,
   240,
   256,
   ...
   592,
   608};
   Double_t Graph_from_Data_fy3002[26] = {
   10,
   10,
   13,
   8,
   ...
   1,
   0};
   Double_t Graph_from_Data_felx3002[26] = {
   8,
   8,
   8,
   8,
   ...
   8,
   8};
   Double_t Graph_from_Data_fely3002[26] = {
   3.108748,
   3.108748,
   3.558726,
   2.768432,
   ...
   0.8272525,
   0};
   Double_t Graph_from_Data_fehx3002[26] = {
   8,
   8,
   8,
   8,
   ...
   8,
   8};
   Double_t Graph_from_Data_fehy3002[26] = {
   4.267035,
   4.267035,
   4.697668,
   3.94522,
   ...
   2.29957,
   1.841055};
   grae = new TGraphAsymmErrors(26,Graph_from_Data_fx3002,Graph_from_Data_fy3002,Graph_from_Data_felx3002,Graph_from_Data_fehx3002,Graph_from_Data_fely3002,Graph_from_Data_fehy3002);
   grae->SetName("Graph_from_Data");
   grae->SetTitle("metnomuons {( (jet1_eta*jet2_eta<0 && abs(jet1_eta)<4.7 && abs(jet2_eta)<4.7 && dijet_M>1100&&jet1_pt>80&&dijet_deta>3.6&& jet2_pt>70&&metnomuons>200) && (nvetomuons==0&&nvetoelectrons==0&&metnomuons>200&&dijet_M>1100&&alljetsmetnomu_mindphi>=2.3&&(pass_sigtrigger==1)) ) * (weight_nolep*1)}");
   grae->SetLineWidth(2);
   grae->SetMarkerStyle(20);
   ...
   TH1F *Graph_Graph_Graph_from_Data30013002 = new TH1F("Graph_Graph_Graph_from_Data30013002","metnomuons {( (jet1_eta*jet2_eta<0 && abs(jet1_eta)<4.7 && abs(jet2_eta)<4.7 && dijet_M>1100&&jet1_pt>80&&dijet_deta>3.6&& jet2_pt>70&&metnomuons>200) && (nvetomuons==0&&nvetoelectrons==0&&metnomuons>200&&dijet_M>1100&&alljetsmetnomu_mindphi>=2.3&&(pass_sigtrigger==1)) ) * (weight_nolep*1)}",100,158.4,657.6);
   Graph_Graph_Graph_from_Data30013002->SetMinimum(0);
   Graph_Graph_Graph_from_Data30013002->SetMaximum(19.46744);
   Graph_Graph_Graph_from_Data30013002->SetDirectory(0);
   Graph_Graph_Graph_from_Data30013002->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph_Graph_from_Data30013002->SetLineColor(ci);
   Graph_Graph_Graph_from_Data30013002->GetXaxis()->SetLabelFont(42);
   Graph_Graph_Graph_from_Data30013002->GetXaxis()->SetLabelSize(0.035);
   Graph_Graph_Graph_from_Data30013002->GetXaxis()->SetTitleSize(0.035);
   Graph_Graph_Graph_from_Data30013002->GetXaxis()->SetTitleFont(42);
   Graph_Graph_Graph_from_Data30013002->GetYaxis()->SetLabelFont(42);
   Graph_Graph_Graph_from_Data30013002->GetYaxis()->SetLabelSize(0.035);
   Graph_Graph_Graph_from_Data30013002->GetYaxis()->SetTitleSize(0.035);
   Graph_Graph_Graph_from_Data30013002->GetYaxis()->SetTitleFont(42);
   Graph_Graph_Graph_from_Data30013002->GetZaxis()->SetLabelFont(42);
   Graph_Graph_Graph_from_Data30013002->GetZaxis()->SetLabelSize(0.035);
   Graph_Graph_Graph_from_Data30013002->GetZaxis()->SetTitleSize(0.035);
   Graph_Graph_Graph_from_Data30013002->GetZaxis()->SetTitleFont(42);
   grae->SetHistogram(Graph_Graph_Graph_from_Data30013002);
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("Signal","Signal","ll");
