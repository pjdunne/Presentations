...
eval ./bin/LTAnalysis --cfg=scripts/DefaultConfig.cfg --channel=munu -o output_contplots_alljets10topalljets0/munu.root &> jobs_contplots_alljets10topalljets0//munu.log
