...
eval ./bin/LTAnalysis --cfg=scripts/DefaultConfig.cfg --channel=mumu -o output_contplots_alljets10topalljets0/mumu.root &> jobs_contplots_alljets10topalljets0//mumu.log
