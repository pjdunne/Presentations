...
eval ./bin/LTAnalysis --cfg=scripts/DefaultConfig.cfg --channel=nunu -o output_contplots_alljets10topalljets0/nunu.root &> jobs_contplots_alljets10topalljets0//nunu.log
