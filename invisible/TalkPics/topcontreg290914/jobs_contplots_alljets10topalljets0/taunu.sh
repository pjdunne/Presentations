...
eval ./bin/LTAnalysis --cfg=scripts/DefaultConfig.cfg --channel=taunu -o output_contplots_alljets10topalljets0/taunu.root &> jobs_contplots_alljets10topalljets0//taunu.log
