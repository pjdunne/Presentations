...
eval ./bin/LTAnalysis --cfg=scripts/DefaultConfig.cfg --channel=top -o output_contplots_alljets10topalljets10/top.root &> jobs_contplots_alljets10topalljets10//top.log
