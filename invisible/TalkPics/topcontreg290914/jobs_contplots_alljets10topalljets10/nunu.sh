...
eval ./bin/LTAnalysis --cfg=scripts/DefaultConfig.cfg --channel=nunu -o output_contplots_alljets10topalljets10/nunu.root &> jobs_contplots_alljets10topalljets10//nunu.log
