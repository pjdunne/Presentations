...
eval ./bin/LTAnalysis --cfg=scripts/DefaultConfig.cfg --channel=enu -o output_contplots_alljets10topalljets10/enu.root &> jobs_contplots_alljets10topalljets10//enu.log
