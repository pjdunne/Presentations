...
eval ./bin/LTAnalysis --cfg=scripts/DefaultConfig.cfg --channel=munu -o output_contplots_alljetsmetdphicut05/munu.root &> jobs_contplots_alljetsmetdphicut05//munu.log
