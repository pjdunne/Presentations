...
eval ./bin/LTAnalysis --cfg=scripts/DefaultConfig.cfg --channel=taunu -o output_contplots_alljetsmetdphicut05/taunu.root &> jobs_contplots_alljetsmetdphicut05//taunu.log
