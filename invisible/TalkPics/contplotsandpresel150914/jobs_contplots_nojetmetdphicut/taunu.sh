...
eval ./bin/LTAnalysis --cfg=scripts/DefaultConfig.cfg --channel=taunu -o output_contplots_nojetmetdphicut/taunu.root &> jobs_contplots_nojetmetdphicut//taunu.log
