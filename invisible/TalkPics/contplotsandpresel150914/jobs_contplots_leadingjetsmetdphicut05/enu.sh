...
eval ./bin/LTAnalysis --cfg=scripts/DefaultConfig.cfg --channel=enu -o output_contplots_leadingjetsmetdphicut05/enu.root &> jobs_contplots_leadingjetsmetdphicut05//enu.log
