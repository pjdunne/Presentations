...
eval ./bin/LTAnalysis --cfg=scripts/DefaultConfig.cfg --channel=mumu -o output_contplots_leadingjetsmetdphicut05/mumu.root &> jobs_contplots_leadingjetsmetdphicut05//mumu.log
