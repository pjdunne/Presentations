...
eval ./bin/LTAnalysis --cfg=scripts/DefaultConfig.cfg --channel=nunu -o output_contplots_alljetsmetdphicut10metsig35/nunu.root &> jobs_contplots_alljetsmetdphicut10metsig35//nunu.log
