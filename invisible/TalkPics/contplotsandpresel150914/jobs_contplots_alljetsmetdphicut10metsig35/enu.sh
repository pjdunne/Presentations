...
eval ./bin/LTAnalysis --cfg=scripts/DefaultConfig.cfg --channel=enu -o output_contplots_alljetsmetdphicut10metsig35/enu.root &> jobs_contplots_alljetsmetdphicut10metsig35//enu.log
