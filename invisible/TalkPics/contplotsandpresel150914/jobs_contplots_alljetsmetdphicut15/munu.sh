...
eval ./bin/LTAnalysis --cfg=scripts/DefaultConfig.cfg --channel=munu -o output_contplots_alljetsmetdphicut15/munu.root &> jobs_contplots_alljetsmetdphicut15//munu.log
