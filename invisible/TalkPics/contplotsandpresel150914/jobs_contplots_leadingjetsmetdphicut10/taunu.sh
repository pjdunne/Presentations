...
eval ./bin/LTAnalysis --cfg=scripts/DefaultConfig.cfg --channel=taunu -o output_contplots_leadingjetsmetdphicut10/taunu.root &> jobs_contplots_leadingjetsmetdphicut10//taunu.log
