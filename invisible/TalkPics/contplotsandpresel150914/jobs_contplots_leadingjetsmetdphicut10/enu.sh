...
eval ./bin/LTAnalysis --cfg=scripts/DefaultConfig.cfg --channel=enu -o output_contplots_leadingjetsmetdphicut10/enu.root &> jobs_contplots_leadingjetsmetdphicut10//enu.log
