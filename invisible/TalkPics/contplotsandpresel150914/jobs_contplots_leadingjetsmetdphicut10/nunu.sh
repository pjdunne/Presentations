...
eval ./bin/LTAnalysis --cfg=scripts/DefaultConfig.cfg --channel=nunu -o output_contplots_leadingjetsmetdphicut10/nunu.root &> jobs_contplots_leadingjetsmetdphicut10//nunu.log
