...
eval ./bin/LTAnalysis --cfg=scripts/DefaultConfig.cfg --channel=taunu -o output_contplots_nojetmetdphicutnotaumtcut/taunu.root &> jobs_contplots_nojetmetdphicutnotaumtcut//taunu.log
