...
eval ./bin/LTAnalysis --cfg=scripts/DefaultConfig.cfg --channel=enu -o output_contplots_nojetmetdphicutnotaumtcut/enu.root &> jobs_contplots_nojetmetdphicutnotaumtcut//enu.log
