...
eval ./bin/LTAnalysis --cfg=scripts/DefaultConfig.cfg --channel=nunu -o output_contplots_nojetmetdphicutnotaumtcut/nunu.root &> jobs_contplots_nojetmetdphicutnotaumtcut//nunu.log
