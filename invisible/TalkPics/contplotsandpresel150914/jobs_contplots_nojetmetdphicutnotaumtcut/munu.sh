...
eval ./bin/LTAnalysis --cfg=scripts/DefaultConfig.cfg --channel=munu -o output_contplots_nojetmetdphicutnotaumtcut/munu.root &> jobs_contplots_nojetmetdphicutnotaumtcut//munu.log
