...
eval ./bin/LTAnalysis --cfg=scripts/DefaultConfig.cfg --channel=taunu -o output_contplots_alljetsmetdphicut10/taunu.root &> jobs_contplots_alljetsmetdphicut10//taunu.log
