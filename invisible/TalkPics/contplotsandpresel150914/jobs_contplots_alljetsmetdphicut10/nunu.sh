...
eval ./bin/LTAnalysis --cfg=scripts/DefaultConfig.cfg --channel=nunu -o output_contplots_alljetsmetdphicut10/nunu.root &> jobs_contplots_alljetsmetdphicut10//nunu.log
