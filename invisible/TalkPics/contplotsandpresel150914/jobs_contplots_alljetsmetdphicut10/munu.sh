...
eval ./bin/LTAnalysis --cfg=scripts/DefaultConfig.cfg --channel=munu -o output_contplots_alljetsmetdphicut10/munu.root &> jobs_contplots_alljetsmetdphicut10//munu.log
