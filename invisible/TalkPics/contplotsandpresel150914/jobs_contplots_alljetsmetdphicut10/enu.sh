...
eval ./bin/LTAnalysis --cfg=scripts/DefaultConfig.cfg --channel=enu -o output_contplots_alljetsmetdphicut10/enu.root &> jobs_contplots_alljetsmetdphicut10//enu.log
