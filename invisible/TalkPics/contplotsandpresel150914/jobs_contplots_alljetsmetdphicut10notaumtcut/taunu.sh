...
eval ./bin/LTAnalysis --cfg=scripts/DefaultConfig.cfg --channel=taunu -o output_contplots_alljetsmetdphicut10notaumtcut/taunu.root &> jobs_contplots_alljetsmetdphicut10notaumtcut//taunu.log
