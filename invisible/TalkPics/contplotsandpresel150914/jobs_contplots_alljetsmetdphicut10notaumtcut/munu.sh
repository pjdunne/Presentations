...
eval ./bin/LTAnalysis --cfg=scripts/DefaultConfig.cfg --channel=munu -o output_contplots_alljetsmetdphicut10notaumtcut/munu.root &> jobs_contplots_alljetsmetdphicut10notaumtcut//munu.log
